...
export default function HomePage() {
    ...
    return (
        ...
        <div className="flex flex-col-reverse justify-center items-center gap-12 p-16">
            <div className="flex flex-col justify-center items-center gap-10 ">
                ...
                <p className={`${merri.className} text-sm leading-7 font-extralight text-opacity-80 text-main-text`}> Hi! I&apos;m an aspiring Web Developer.
