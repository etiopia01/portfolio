...
<div className="opacity-0 peer-hover:opacity-60 text-main-text peer-hover:transition-opacity w-64 h-auto text-sm absolute bottom-auto mt-8">{props.des}</div>
</div>
    )
}